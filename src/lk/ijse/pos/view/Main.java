...
//        }
    ...
    private int getMenuItemIndex(Object source) {
        ...
        if (source instanceof JLabel && ((JLabel) source).getName() == null) {
            // This is probabiliy what we are looking for
            lbl = (JLabel) source;
        } else {
    ...
    private void initComponents() {
        ...
        pnlMenu.setBounds(60, 280, 630, 200);
