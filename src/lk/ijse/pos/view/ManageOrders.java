...
import lk.ijse.pos.controller.ManageItemController;
import lk.ijse.pos.controller.ManageItemDetailController;
import lk.ijse.pos.controller.ManagerOrderController;
...
public class ManageOrders extends javax.swing.JFrame {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtItemDesc, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel6))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED, 30, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel7)
                            .addComponent(txtQtyOnHand, javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        tblAllOrders.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Id", "Customer Id", "Customer Name", "Date", "Amount"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(TabbedPaneAllOrders, javax.swing.GroupLayout.Alignment.TRAILING)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(TabbedPaneAllOrders))
        );
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if (rowCount > 0) {
            for (int i = 0; i < rowCount; i++) {
                if (cartModel.getValueAt(i, NORMAL).equals(itemCode)) {
                    row = i;
                    break;
                }
            }
    ...
    private void txtCustomerIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCustomerIdActionPerformed
        try {
            ...
            CustomerDTO dto = ManageCustomerController.findById(customerId);
    ...
    private void txtItemCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtItemCodeActionPerformed
        try {
            ...
            ItemDTO dto = ManageItemController.findById(itemCode);
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        try {
            ...
            orderDTO.setId(txtOrderId.getText());
            orderDTO.setDate(new Date(System.currentTimeMillis()));

            for (int i = 0; i < rowCount; i++) {
                itemDetailDTOs.add(new ItemdetailDTO(
                        orderDTO.getId(),
                        cartModel.getValueAt(i, NORMAL).toString(),
                        (int) Double.parseDouble(cartModel.getValueAt(i, 2).toString()),
                        new BigDecimal(Double.parseDouble(cartModel.getValueAt(i, 1).toString()))
                        
                ));
            }

            orderDTO.setItemDetails(itemDetailDTOs);

            if (ManagerOrderController.saveOrder(orderDTO)) {
    ...
    private void btnDeleteOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteOrderActionPerformed
        try {
            ...
            String itemCode = txtItemCode.getSelectedText();
            boolean result = ManageItemDetailController.deleteItemDetail(orderId, itemCode);
    ...
    private void TabbedPaneAllOrdersFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_TabbedPaneAllOrdersFocusGained
        try {
            List<OrdersDTO> allOrders = ManagerOrderController.getAllOrders();
